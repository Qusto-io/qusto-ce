defmodule PlausibleWeb.Live.SSOManagement do
  ...
  def init_view(assigns) do
    ...
    <form id="sso-init" for={} phx-submit="init-sso">
      <p class="text-sm">
        Single Sign-On (SSO) enables team members to sign in without having to register an account. For more details, <.styled_link href="https://docs.qusto.io/sso">see our documentation</.styled_link>.
      </p>
