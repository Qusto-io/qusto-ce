defmodule PlausibleWeb.Live.ResetPasswordForm do
  ...
  def render(assigns) do
    ...
    <.form
      ...
      class="bg-white dark:bg-[var(--color-dark-bg-elevated)] max-w-md w-full mx-auto shadow-md rounded-sm px-8 py-6 mt-8"
    >
      ...
      <div class="my-4">
        ...
        <.password_input_with_strength
          ...
          phx-debounce={200}
          class="transition bg-gray-100 dark:bg-[var(--color-dark-bg-card)] outline-hidden appearance-none border border-transparent rounded-xs w-full p-2 text-gray-700 dark:text-gray-300 leading-normal focus:outline-hidden focus:bg-white dark:focus:bg-gray-800 focus:border-gray-300 dark:focus:border-gray-500"
        />
      </div>
